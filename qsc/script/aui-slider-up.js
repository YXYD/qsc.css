...
(function(window){
    ...
    aui.sliderUp = function(element,callback){
                ...
                if (self.offsetY > 0) {//down
                    for(i; i < m; i++){
                        ...
                        if (i == self.initIndex - 1) {
                            ...
                            lis[i] && (lis[i].style.webkitTransition = 'http://www.auicss.com/aui/script/-webkit-transform 0.1s');
        ...
        var _goIndex = function(n){
            ...
            //改变过渡的方式，从无动画变为有动画
            lis[currIndex].style.webkitTransition = 'http://www.auicss.com/aui/script/-webkit-transform 0.2s';
            lis[currIndex-1] && (lis[currIndex-1].style.webkitTransition = 'http://www.auicss.com/aui/script/-webkit-transform 0.2s');
            lis[currIndex+1] && (lis[currIndex+1].style.webkitTransition = 'http://www.auicss.com/aui/script/-webkit-transform 0.2s');
